...
var Calendar = function (_React$Component) {
    ...
    function Calendar(props) {
        ...
        _this.getDefaultLocale = function () {
            var result = (0, _extends3['default'])({}, _ru_RU2['default'], _this.props.locale);
        ...
        _this.renderCalendar = function (locale, localeCode) {
            ...
            var spinnerIcon = React.createElement(_index3.Icon, { type: 'loading', style: { padding: '1em', fontSize: 30 } });
            var loader = React.createElement(_index2['default'], { indicator: spinnerIcon, style: { width: '100%' } });
            var calendarContent = React.createElement(
                'div',
                null,
                React.createElement(_Header2['default'], { fullscreen: fullscreen, type: type, value: value, defaulValue: defaultValue, locale: locale.lang, prefixCls: prefixCls, onTypeChange: _this.onHeaderTypeChange, onValueChange: _this.onHeaderValueChange, showNavigation: showNavigation }),
