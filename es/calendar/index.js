...
var Calendar = function (_React$Component) {
    ...
    function Calendar(props) {
        ...
        _this.renderCalendar = function (locale, localeCode) {
            ...
            var spinnerIcon = React.createElement(Icon, { type: 'loading', style: { padding: '1em', fontSize: 30 } });
            var loader = React.createElement(Spin, { indicator: spinnerIcon, style: { width: '100%' } });
            var calendarContent = React.createElement(
                'div',
                null,
                React.createElement(Header, { fullscreen: fullscreen, type: type, value: value, defaulValue: defaultValue, locale: locale.lang, prefixCls: prefixCls, onTypeChange: _this.onHeaderTypeChange, onValueChange: _this.onHeaderValueChange, showNavigation: showNavigation }),
